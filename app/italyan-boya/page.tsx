...
export const metadata: Metadata = {
  title: "İtalyan Boya Sakarya | Dekoratif Boya Uygulamaları",
  description:
    "Akova Dekorasyon ile Sakarya, Kocaeli ve Düzce'de İtalyan boya ve dekoratif duvar uygulamaları. Yaşam alanlarınıza özel modern ve estetik yüzey çözümleri.",
  alternates: {
    canonical: "/italyan-boya",
  },
};

const allowedExtensions = [".jpg", ".jpeg", ".png", ".webp", ".avif"];

function getItalianPaintImages() {
  ...
  return fs
    ...
    .slice(0, 6)
    .map((file) => `/galeri/italyan-boya/${file}`);
}

const features = [
  "Dekoratif duvar yüzeyleri",
  "Modern ve özgün görünüm",
  "Mekâna özel uygulama seçenekleri",
  "İç mekân dekorasyonuyla uyum",
  "Farklı doku ve yüzey alternatifleri",
  "Profesyonel uygulama",
];

export default function ItalyanBoyaPage() {
  const images = getItalianPaintImages();
        ...
        <div className="relative mx-auto grid max-w-7xl gap-14 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            ...
            <h1 className="mt-6 max-w-4xl text-5xl font-black leading-[1.02] tracking-[-0.05em] sm:text-6xl lg:text-7xl">
              Sakarya&apos;da İtalyan boya
              <span className="mt-2 block bg-gradient-to-r from-[#c32858] via-[#975282] to-[#3977c1] bg-clip-text text-transparent">
                ve dekoratif yüzeyler.
              </span>
            </h1>

            <p className="mt-8 max-w-2xl text-lg leading-8 text-white/55">
              Akova Dekorasyon olarak Sakarya, Kocaeli ve Düzce&apos;de
              yaşam alanlarına karakter kazandıran İtalyan boya ve dekoratif
              duvar uygulamaları gerçekleştiriyoruz.
            </p>

            <div className="mt-10 flex flex-col gap-4 sm:flex-row">
              <a
                href="https://wa.me/905324996165?text=Merhaba%2C%20%C4%B0talyan%20boya%20uygulamas%C4%B1%20hakk%C4%B1nda%20bilgi%20almak%20istiyorum."
                target="_blank"
          ...
          <div className="relative min-h-[520px] overflow-hidden rounded-[32px] border border-white/10 bg-white/[0.035]">
            {images[0] ? (
              <>
                <img
                  src={images[0]}
                  alt="Akova Dekorasyon İtalyan boya uygulaması"
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8">
              ...
              <p className="mt-3 text-3xl font-bold">
                Duvarlara karakter kazandıran detaylar.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="px-5 py-24 sm:px-8">
        <div className="mx-auto max-w-7xl">
          <p className="text-xs font-semibold tracking-[0.3em] text-[#3977c1]">
            İTALYAN BOYA UYGULAMALARI
          </p>

          <h2 className="mt-5 max-w-3xl text-4xl font-black tracking-[-0.04em] sm:text-5xl">
            Mekânın atmosferini değiştiren yüzeyler.
          </h2>

          <p className="mt-6 max-w-3xl leading-8 text-white/50">
            Dekoratif boya uygulamaları; klasik düz duvar görünümünün
            ötesine geçerek mekâna doku, derinlik ve özgün bir karakter
            kazandırabilir.
          </p>
            ...
            <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
              {images.slice(1).map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`Akova Dekorasyon İtalyan boya çalışması ${
                      index + 1
                    }`}
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <p className="mt-6 max-w-xl leading-8 text-white/50">
                İtalyan boya ve dekoratif yüzey uygulamalarımız için proje
                detaylarını değerlendiriyor, mekâna uygun çözümler
                oluşturuyoruz.
              </p>
            </div>
      ...
      <section className="px-5 pb-24 sm:px-8 lg:pb-32">
        <div className="mx-auto max-w-7xl rounded-[36px] bg-gradient-to-r from-[#831535] to-[#284f85] px-7 py-16 text-center sm:px-12 lg:py-20">
          ...
          <h2 className="mx-auto mt-5 max-w-4xl text-4xl font-black tracking-[-0.04em] sm:text-5xl">
            İtalyan boya uygulaması için bizimle iletişime geçin.
          </h2>

          <p className="mx-auto mt-6 max-w-2xl leading-7 text-white/70">
            Mekânınızı birlikte değerlendirelim ve uygulanabilecek dekoratif
            yüzey seçeneklerini konuşalım.
          </p>
