...
export const metadata: Metadata = {
  title: "Banyo Yenileme Sakarya | Banyo Tadilatı",
  description:
    "Akova Dekorasyon ile Sakarya, Kocaeli ve Düzce'de banyo yenileme ve banyo tadilatı. Seramik, su yalıtımı, dekorasyon ve modern banyo çözümleri.",
  alternates: {
    canonical: "/banyo-yenileme",
  },
};
...
function getBathroomImages() {
  ...
  return fs
    ...
    .slice(0, 6)
    .map((file) => `/galeri/banyo/${file}`);
}

const features = [
  "Banyo yenileme ve tadilat",
  "Seramik ve yüzey uygulamaları",
  "Su yalıtımı uygulamaları",
  "Lavabo ve kullanım alanı düzenleme",
  "Aydınlatma ve dekoratif detaylar",
  "Modern ve kullanışlı tasarım",
];
...
const steps = [
  {
    ...
    title: "Keşif",
    description:
      "Mevcut banyoyu inceliyor, ihtiyaçları ve yapılacak uygulamaları belirliyoruz.",
  },
  {
    number: "02",
    title: "Planlama",
    description:
      "Seramik, yüzey, kullanım alanı ve dekoratif detayların kapsamını netleştiriyoruz.",
  },
  {
    number: "03",
    title: "Uygulama",
    description:
      "Tadilat ve yenileme çalışmalarını planlanan sıraya göre gerçekleştiriyoruz.",
  },
  {
    number: "04",
    title: "Teslim",
    description:
      "Son kontroller tamamlandıktan sonra banyoyu kullanıma hazır şekilde teslim ediyoruz.",
  },
];

export default function BanyoYenilemePage() {
  const images = getBathroomImages();
        ...
        <div className="relative mx-auto grid max-w-7xl gap-14 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            ...
            <p className="mt-8 max-w-2xl text-lg leading-8 text-white/55">
              ...
              estetik, kullanışlı ve uzun ömürlü banyo yenileme ve tadilat
              uygulamaları gerçekleştiriyoruz.
            </p>

            <div className="mt-10 flex flex-col gap-4 sm:flex-row">
              <a
                href="https://wa.me/905324996165?text=Merhaba%2C%20banyo%20yenileme%20hakk%C4%B1nda%20bilgi%20almak%20istiyorum."
                target="_blank"
          ...
          <div className="relative min-h-[520px] overflow-hidden rounded-[32px] border border-white/10 bg-white/[0.035]">
            {images[0] ? (
              <>
                <img
                  src={images[0]}
                  alt="Akova Dekorasyon banyo yenileme çalışması"
      ...
      <section className="px-5 py-24 sm:px-8">
        <div className="mx-auto max-w-7xl">
          ...
          <h2 className="mt-5 max-w-3xl text-4xl font-black tracking-[-0.04em] sm:text-5xl">
            Banyonuzu baştan sona yenileyin.
          </h2>

          <p className="mt-6 max-w-3xl leading-8 text-white/50">
            Banyo yenileme sürecinde yüzey uygulamalarından su yalıtımına,
            kullanım alanlarından dekoratif detaylara kadar mekânın
            ihtiyaçlarını bütün olarak değerlendiriyoruz.
          </p>
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <p className="mt-6 max-w-xl leading-8 text-white/50">
                Banyo yenileme ve tadilat projelerinde mekânın mevcut
                durumunu ve yapılacak uygulamaları değerlendirerek uygun
                çalışma planını oluşturuyoruz.
              </p>
            </div>
